...
> **文件摘要**: 本章构建基于经济增长与通胀双重维度的四季气候模型，提供从全天候底仓配置到动态调仓机制的完整周期应对框架。通过量化信号-阈值-动作的决策体系，实现被动配置与主动调整的有机结合。
...
| **秋：滞胀** (Growth ↓, Inflation ↑) | 经济停滞，物价仍高 (滞胀最难受的时期) | **现金/TIPS** (抗通胀债) | 股票 (盈利杀) & 债券 (估值杀) |
...
上一章：[07 资产配置与对冲模型——哑铃策略与三桶金](07-asset-correlation-matrix.md) · 下一章：[09 情报系统](09-intelligence-system.md)
