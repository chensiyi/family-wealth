...
> **文件摘要**: 本章建立完整的知识管理体系，提供从理论基础到实务工具的系统性索引框架。通过标准化的条目模板、更新节奏和引用规范，确保整个知识体系的可维护性和可持续发展。
...
## 索引结构（建议）
- **核心理论库** (15-master-theories.md)
    - 现代投资组合理论 (Markowitz)
    - 全天候策略 (Dalio)
    - 反脆弱与杠铃策略 (Taleb)
    - 行为金融学 (Shiller)
- **工具与模型**
    - 资产相关性矩阵 (07-asset-correlation-matrix.md)
    - 周期配置模型 (08-cycle-configuration.md)
    - 家族宪章模板 (06-family-governance.md)
